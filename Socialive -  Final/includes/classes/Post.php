    ...
    class Post {
            	...
            	while($row = mysqli_fetch_array($data_query)) {
                    ...
                    if($user_logged_obj->isFriend($added_by)) {
                    	...
                    	if($userLoggedIn == $added_by) {
                    	    $delete_button = "<button class='delete_button' id='post$id'><i class='fa fa-times fa-lg'></i>";
                    	} else {
                    	    $delete_button = "";
                    	}
    					...
    					$str .= "<div class='status_post' onClick='javascript:toggle$id(event)'>
    								...
    								<div class='newsfeedPostOptions'>
    								    ...
    								    <iframe src='like.php?post_id=$id' scrolling='no' style='background: transparent;'></iframe>
    								</div>
    
    							</div>
    							<div class='post_comment' id='toggleComment$id' style='display: none;width: 100%;'>
    							    <iframe src='comment_frame.php?post_id=$id' style='width: 100%;max-height: 250px;' id='comment_iframe' frameborder=0></iframe>
    							</div>
    							<hr>";
        			}//User_logged_obj isFriend() If
    	...
    	public function loadProfilePosts($data, $limit) {
            ...
            if(mysqli_num_rows($data_query) > 0) {
    		    ...
    		    $getNameToDisplay = new User($this->con, $profile_user);
    		    $name = $getNameToDisplay->getFirstAndLastName();
    		    echo "<h1>No Posts Have Been Posted By $name</h1>";
    		}
    		echo $str;
    	}
            ...
            if(mysqli_num_rows($data_query) > 0) {
            	...
            	$row = mysqli_fetch_array($data_query);
                    ...
                    <?php
        			    ...
        			    echo "<p>You Can't See This Post Because You are not friend with this user.</p>";
        			    return;
        			}
    		} else {
    		    echo "<p>No Posts Found. If You Get Here From a Link, Then It May Be Broken!</p>";
        	    return;
    		}
    		echo $str;
    	}
